...
const contract = new ethers.Contract(
    "0x97a4e48f2CE6DA2F09f9a5437D0c3610C73911c9",
    abi,
    wallet
);

export const mintNFT = async (address: string, image: string, display_name: string, interactor: string) => {
    const metadata = {
        name: `${display_name} on Farcaster`,
